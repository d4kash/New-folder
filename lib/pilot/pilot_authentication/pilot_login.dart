...
class PilotLoginState extends State<PilotLogin> {
  ...
  static const String KEYDLNUMBER= "DLNumber";
  static const String KEYTOKEN= "Token";

  TextEditingController dlController = TextEditingController();
  TextEditingController passwordController = TextEditingController();

  Future PilotLoginMethod(String dlNumber, password) async {
    if (dlNumber == '' || password == '') {
      ...
      try {
        response = await http.post(
            Uri.parse(
                'https://000quaslq5.execute-api.ap-south-1.amazonaws.com/orange_yatri/orangeYatri_pilot_login'),
            body: jsonData);
        ...
        if (response.statusCode == 200) {
          ...
          if (newResponse['body-json']['statusCode'] == 200) {
            ...
            pref.setBool(SplashScreenState.KEYLOGINPERSIST, true);
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                ...
                image: DecorationImage(
                    image: AssetImage('assets/images/truck image.jpg'),
                    fit: BoxFit.cover),
              ),
              child: const Column(
  ...
  void storeDLNumber(String dlNumber) async {
    ...
    var pref = await SharedPreferences.getInstance();
    pref.setString(KEYDLNUMBER, dlNumber);
